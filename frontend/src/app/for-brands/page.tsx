      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
              ...
              {isForYouOpen && (
                <>
                  ...
                  <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-20">
                    ...
                    <Link href="/for-brands" onClick={() => setIsForYouOpen(false)} className="block px-4 py-3 hover:bg-gray-50 font-medium">For Brands</Link>
                  </div>
                </>
              )}
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white px-6 py-4 space-y-3">
            ...
            <Link href="/for-brands" className="block text-black font-medium py-2" onClick={() => setMobileMenuOpen(false)}>For Brands</Link>
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="space-y-6 text-lg text-gray-600 mb-12">
            <p className="leading-relaxed">Generative AI advertising is transforming creative production.</p>
            <p className="leading-relaxed">AI makes campaigns faster, cheaper, and more scalable than traditional production. What&apos;s missing are real, verified human faces.</p>
            <p className="leading-relaxed">Face Library connects brands with licensed digital likeness from real models, actors, influencers, and athletes, enabling authentic AI campaigns with full rights and approvals.</p>
          </div>
          <Link href="/client/register" className="bg-black text-white px-8 py-4 rounded-lg hover:bg-gray-800 transition-colors text-lg inline-block">Register as Brand</Link>
        </div>
      </main>
