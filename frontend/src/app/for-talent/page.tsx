      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
              ...
              {isForYouOpen && (
                <>
                  ...
                  <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-20">
                    <Link href="/for-talent" onClick={() => setIsForYouOpen(false)} className="block px-4 py-3 hover:bg-gray-50 font-medium">For Talents</Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white px-6 py-4 space-y-3">
            ...
            <Link href="/for-talent" className="block text-black font-medium py-2" onClick={() => setMobileMenuOpen(false)}>For Talents</Link>
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="space-y-6 text-lg text-gray-600 mb-12">
            <p className="leading-relaxed">In the age of AI, your likeness can be recreated and used without permission. Face Library helps you verify your identity, create your digital avatar, and control how your likeness is used.</p>
            <p className="leading-relaxed">You can license your face for campaigns, protect your identity, and earn from your digital likeness.</p>
          </div>
          <Link href="/talent/register" className="bg-black text-white px-8 py-4 rounded-lg hover:bg-gray-800 transition-colors text-lg inline-block">Register here</Link>
        </div>
      </main>
