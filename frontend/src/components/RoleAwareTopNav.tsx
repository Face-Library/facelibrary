...
function tabsFor(role: string | undefined) {
  if (role === "talent") return TALENT_TABS;
  if (role === "agent") return AGENT_TABS;
  if (role === "client" || role === "brand") return BRAND_TABS;
  return [];
}

export default function RoleAwareTopNav({ active }: { active: string }) {
